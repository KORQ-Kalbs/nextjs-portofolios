...
export default function Projects() {
  ...
  return (
    <section id="projects-section" className="relative min-h-screen w-full bg-black text-white py-20 grid-bg">
      <div className="max-w-7xl mx-auto px-12">
        {/* Section Title - Broken Grid */}
        <div className="mb-20 space-y-4">
          <h2 className="text-5xl lg:text-6xl font-heading font-bold tracking-tight">SELECTED WORK</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {projects.map((project) => (
            <a
              ...
              className="project-card group relative border-2 border-white p-0 hover:border-[#ff00ff] transition-all duration-300 cursor-pointer"
            >
              {/* Project Header */}
              <div className="p-6 border-b-2 border-white bg-black">
                ...
                <p className="text-xs font-bold tracking-widest uppercase text-white/60">{project.subtitle}</p>
              </div>
              ...
              <div className="p-6 space-y-4 bg-black/50">
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="text-xs font-bold tracking-widest uppercase border border-white/40 px-3 py-1 group-hover:border-[#ff00ff] group-hover:text-[#ff00ff] transition"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        {/* View All CTA */}
        <div className="border-t-2 border-white pt-12 text-center">
          <a
